...
def main():
    ...
    missing_ck.to_csv("downloads/missing_alphabetical.csv", index=False, sep=";")
    missing_ck = missing_ck.sort_values("price", ascending=False).reset_index(drop=True)

    missing_ck.to_csv("downloads/missing_price.csv", index=False, sep=";")
